...
/**
 * Internal Slot implementation to eliminate `@radix-ui/react-slot` dependency
 */
...
>(({ children, ...props }, forwardedRef) => {
  if (React.isValidElement(children)) {
    const childrenProps = (children.props as React.HTMLAttributes<HTMLElement>) || {};
    const childrenRef = (children as unknown as { ref?: PossibleRef<HTMLElement> }).ref;

    const mergedProps: Record<string, unknown> = { ...props, ...childrenProps };

    for (const propName in props) {
      if (
          /^on[A-Z]/.test(propName) &&
          typeof (props as Record<string, unknown>)[propName] === "function" &&
          typeof (childrenProps as Record<string, unknown>)[propName] === "function"
      ) {
        mergedProps[propName] = (...args: unknown[]) => {
          ((childrenProps as Record<string, unknown>)[propName] as (...args: unknown[]) => void)(...args);
          ((props as Record<string, unknown>)[propName] as (...args: unknown[]) => void)(...args);
        };
      }
    }
    ...
    return React.cloneElement(children, {
      ...
      style: { ...props.style, ...childrenProps.style },
