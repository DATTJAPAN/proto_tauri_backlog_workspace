...
export function _apiKeyForm(
    ...
    // ! DANGER: expose api temporarily
    const [apiKey, setApiKey] = useState('Fo27OMdA0osundFu72YrVNElg5VF7d0MqTQGeKkymi1F4RMHdac3pDIuDLz8uV2P')
    ...
    useEffect(() => {
        ...
        void backlog.getConnection().then((connection) => {
            if (active && connection?.method === 'api-key') {
